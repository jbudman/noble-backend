...
HEADLESS_OPTIONS = {'chrome_options': chrome_options}
...
class DBUtils:
    ...
    def test_connection(self, conn):
        query = '''select count(*) from noble_user'''
    ...
    def add_user(self, conn, user_email, user_first, user_last, user_employer_company,
                 linkedin_url, linkedin_photo_url, job_title, location, created):

        query = '''insert into noble_user set user_first_name = {}, user_last_name = {},
         user_employer_company = {}, linkedin_url = {}, linkedin_photo_url = {}, job_title = {},
         location = {}, email_addr = {}, created = {} if not exists (select email_addr from 
          noble_user where email_addr = {})'''

        cur = self.conn.cursor()

        cur.execute(query.format(user_first, user_last, user_employer_company, linkedin_url, linkedin_photo_url,
                                 job_title, location, user_email, ))
