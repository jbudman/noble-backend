...
class Scraper(object):
    ...
    def __init__(self, cookie='None', scraperInstance=None, driver=selenium.webdriver.Chrome("/opt/chromedriver", options=chrome_options), scroll_pause=0.4, scroll_increment=300, timeout=100):
    ...
    def login(self, email, password):
        self.driver.get('https://www.linkedin.com/login')
        time.sleep(1)
        email_input = self.driver.find_element(by=By.XPATH, value='//*[@id="username"]')
        time.sleep(2)
        email_input.send_keys(email)

        pass_input = self.driver.find_element(by=By.XPATH, value='//*[@id="password"]')
        time.sleep(2)
