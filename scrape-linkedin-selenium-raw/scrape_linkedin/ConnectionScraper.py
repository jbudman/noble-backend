...
class ConnectionScraper(Scraper):
    ...
    def get_first_connections(self):
        try:
            time.sleep(4)
            element = self.driver.find_element_by_xpath('//a[contains(@href, "connectionOf")]')
            element.click()
            time.sleep(2)
    ...
    def scrape_page(self):
        ...
        time.sleep(3)
        urls = self.driver.find_elements_by_xpath('//a[contains(@href, "www.linkedin.com/in/")]')
        ...
        image_links = self.driver.find_elements_by_xpath('//img[contains(@class, "presence-entity__image")]')
        ...
        positions = self.driver.find_elements_by_xpath('//div[contains(@class, "entity-result__primary-subtitle t-14 t-black t-normal")]')
        position_list = []
        company_list = []
        ...
        locations = self.driver.find_elements_by_xpath('//div[contains(@class, "entity-result__secondary-subtitle t-14 t-normal")]')
        location_list = []
